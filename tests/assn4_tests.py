...
def test_1_create_stocks():
    ...
    assert response1.status_code == 201 , f"Expected 200 or 201, got {response1.status_code}. Response: {response1.text}"
    ...
    assert response2.status_code == 201 , f"Expected 200 or 201, got {response2.status_code}. Response: {response2.text}"
    ...
    assert response3.status_code == 201 , f"Expected 200 or 201, got {response3.status_code}. Response: {response3.text}"
